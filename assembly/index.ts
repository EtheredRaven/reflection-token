...
export function main(): i32 {
  ...
  switch (contractArgs.entry_point) {
    case 0xd5d7a6c4: {
      const args = Protobuf.decode<ProtoNamespace.init_token_arguments>(
        contractArgs.args,
        ProtoNamespace.init_token_arguments.decode
      );
      const res = c.init_token(args);
    ...
    case 0x0c762220: {
      const args = Protobuf.decode<ProtoNamespace.balance_of_t_arguments>(
        contractArgs.args,
        ProtoNamespace.balance_of_t_arguments.decode
      );
      const res = c.balance_of_t(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.uint64.encode);
      break;
    }
    ...
    case 0x4a1cfa69: {
      const args =
        Protobuf.decode<ProtoNamespace.get_excluded_from_rewards_array_arguments>(
          contractArgs.args,
          ProtoNamespace.get_excluded_from_rewards_array_arguments.decode
        );
      const res = c.get_excluded_from_rewards_array(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.address_array.encode);
      break;
    }
    ...
    case 0xa7f67cca: {
      const args =
        Protobuf.decode<ProtoNamespace.exclude_fee_collection_state_arguments>(
          contractArgs.args,
          ProtoNamespace.exclude_fee_collection_state_arguments.decode
        );
      const res = c.exclude_fee_collection_state(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_message.encode);
      break;
    }
    ...
    case 0x424d98ae: {
      const args =
        Protobuf.decode<ProtoNamespace.exclude_reward_collection_state_arguments>(
          contractArgs.args,
          ProtoNamespace.exclude_reward_collection_state_arguments.decode
        );
      const res = c.exclude_reward_collection_state(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_message.encode);
      break;
    }
